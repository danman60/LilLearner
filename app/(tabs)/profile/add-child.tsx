...
import { useAddChild } from '@/src/hooks/useChildren';
    ...
    >
      ...
      >
        <View style={styles.paper}>
          ...
          <Text style={styles.header}>Add a Little Learner</Text>

          <View style={styles.defaultAvatar}>
            <Text style={styles.defaultAvatarEmoji}>🧒</Text>
          </View>
          <Text style={styles.avatarHint}>Avatar can be changed later</Text>
          ...
          <TouchableOpacity
            style={[
              styles.addButton,
              addChild.isPending && styles.addButtonDisabled,
            ]}
          ...
          >
            {addChild.isPending ? (
              ...
              <Text style={styles.addButtonText}>Add Learner</Text>
            )}
          </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  addButton: {
    ...
    ...shadows.small,
    // Construction paper texture effect
    borderWidth: 1,
